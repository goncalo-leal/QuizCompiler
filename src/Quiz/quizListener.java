...
public interface quizListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link quizParser#variable}.
	 * @param ctx the parse tree
	 */
	void enterNumberVariable(quizParser.NumberVariableContext ctx);
	/**
	 * Exit a parse tree produced by the {@code numberVariable}
	 * labeled alternative in {@link quizParser#variable}.
	 * @param ctx the parse tree
	 */
	void exitNumberVariable(quizParser.NumberVariableContext ctx);
	/**
	 * Enter a parse tree produced by the {@code textVariable}
	 * labeled alternative in {@link quizParser#variable}.
	 * @param ctx the parse tree
	 */
	void enterTextVariable(quizParser.TextVariableContext ctx);
	/**
	 * Exit a parse tree produced by the {@code textVariable}
	 * labeled alternative in {@link quizParser#variable}.
	 * @param ctx the parse tree
	 */
	void exitTextVariable(quizParser.TextVariableContext ctx);
	/**
