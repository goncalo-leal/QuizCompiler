...
public interface quizVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitNumberVariable(quizParser.NumberVariableContext ctx);
	/**
	 * Visit a parse tree produced by the {@code textVariable}
	 * labeled alternative in {@link quizParser#variable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTextVariable(quizParser.TextVariableContext ctx);
	/**
